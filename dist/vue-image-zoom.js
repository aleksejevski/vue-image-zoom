...
var rGen = function () {
	...
	for (var i = 0; i < length; i++) {
		var position = Math.floor(Math.random() * charSetLength);
...
var viewerComponent = { render: function render() {
  ...
  methods: {
    ...
    modalClicked: function modalClicked() {
...
var viewerConstuctor = Vue$3.extend(viewerComponent);
...
var Viewer = function Viewer() {
  ...
  if (Vue$3.prototype.$isServer) return;
  ...
  var id = 'image-zoom_' + randomId + '_' + seed++;
